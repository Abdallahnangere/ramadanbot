  ...
  return (
    ...
    >
        ...
        <div className="rb-container">
          <div className="rb-nav-inner">
            ...
            <div className="rb-nav-actions">
              ...
              <Link href="/app" className="rb-btn-primary rb-btn-sm rb-hide-mobile">
      ...
      <main>
          ...
          <div className="rb-container rb-hero-grid">
            ...
            <div className="rb-hero-text animate-fiu">
              ...
              <div className="rb-hero-ctas">
                <Link href="/app" className="rb-btn-primary rb-btn-lg">
                  Start for free <ArrowRight size={17} />
                </Link>
                <button onClick={() => scrollToSection('showcase')} className="rb-btn-secondary rb-btn-lg">
                  See it in action
                </button>
              </div>
            ...
            <div className="rb-hero-phone-col animate-fiu" style={{ animationDelay: '0.2s' }}>
              <div className="rb-phone-platform-glow" />
              <div className="rb-elite-phone">
                <div className="rb-phone-rim" />
                <div className="rb-phone-vol-silent" />
                <div className="rb-phone-vol-up" />
                <div className="rb-phone-vol-down" />
                <div className="rb-phone-power" />
                <div className="rb-phone-inner">
                  <div className="rb-phone-island" />
                  <div className="rb-phone-screen">
                    <div className="rb-phone-sheen" />
                    <Image src="/generate.png" alt="RamadanBot App" fill className="object-cover object-top" priority />
                  </div>
                </div>
                <div className="rb-phone-speaker" />
              </div>

              {/* Floating chips */}
              <div className="rb-chip rb-chip--top animate-fiu" style={{ animationDelay: '0.55s' }}>
                <div className="rb-chip-ico rb-chip-ico--gold">
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                  </svg>
                </div>
                <div>
                  <div className="rb-chip-title">Streak Active</div>
                  <div className="rb-chip-sub">Day 14 of Ramadan</div>
                </div>
              </div>

              <div className="rb-chip rb-chip--bottom animate-fiu" style={{ animationDelay: '0.75s' }}>
                <div className="rb-chip-ico rb-chip-ico--emerald">
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                    <path d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/>
                  </svg>
                </div>
                <div>
                  <div className="rb-chip-title">Reflection Ready</div>
                  <div className="rb-chip-sub">Al-Baqarah · Verse 183</div>
                </div>
              </div>
            </div>
        ...
        {/* ═══════════════════════ FEATURES ═══════════════════════
            PERFECT BENTO:
            Row 1 (desktop): [AI Reflections ×2] [Qur'an Reader ×1]
            Row 2 (desktop): [Featured Name ×1] [Streak ×1] [Sharing ×1]
        ═══════════════════════════════════════════════════════════ */}
          ...
          <div className="rb-container">
            <div className="rb-section-header">
              ...
              <h2 className="rb-section-title">
                One app.<br /><span className="rb-muted">Every act of worship.</span>
              </h2>
            </div>
        ...
        <section className="rb-section rb-section--alt">
          ...
          <div className="rb-container rb-reader-grid">
            ...
            <div className="rb-reader-left">
              ...
              <h2 className="rb-section-title rb-title--left">
                Structured reading,<br /><span className="rb-muted">beautifully designed.</span>
              </h2>
              ...
              <div className="rb-steps">
                {[
                  ...
                  <div key={s.n} className="rb-step">
                    ...
                    <div>
                      <div className="rb-step-t">{s.t}</div>
                      <div className="rb-step-d">{s.d}</div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="rb-dist-card">
              ...
              {[
                ...
                <div key={i} className="rb-dist-block">
                  <div className="rb-dist-bh">
                    <span>{block.l}</span>
                    <span className={`rb-badge ${block.bc}`}>{block.b}</span>
                  </div>
                  {block.rows.map(([k, v], j) => (
                    <div key={j} className={`rb-dist-row ${j === block.rows.length - 1 ? 'rb-dist-row--last' : ''}`}>
          ...
          <div className="rb-container" style={{ position: 'relative', zIndex: 2 }}>
            ...
            <div className="rb-stage">
              {[
                ...
                { title: 'Prayer Times', src: '/prayer.png',    desc: 'Daily Schedule',     tilt: '10deg',  ty: '44px', sc: '0.87' },
              ].map((s, i) => (
                <div
                  key={i}
                  className="rb-stage-item"
                  style={{ '--tilt': s.tilt, '--ty': s.ty, '--sc': s.sc } as React.CSSProperties}
                >
          ...
          <div className="rb-footer-grid">
            <div>
              <div className="rb-footer-logo">
                <div className="rb-footer-logo-mark">
...
function getGlobalCSS() {
  return `
    ...
    :root, [data-theme="light"] {
      ...
      --gold-brd:     rgba(184,144,10,0.22);
      --gold-t:       #9A7608;
      --emerald:      #047857;
      --em-dim:       rgba(4,120,87,0.08);
      --em-brd:       rgba(4,120,87,0.18);
      --amber:        #B45309;
      --am-dim:       rgba(180,83,9,0.08);
      --am-brd:       rgba(180,83,9,0.18);
      --blue:         #1D4ED8;
      --bl-dim:       rgba(29,78,216,0.08);
      --bl-brd:       rgba(29,78,216,0.18);
      --purple:       #6D28D9;
      --pu-dim:       rgba(109,40,217,0.08);
      --pu-brd:       rgba(109,40,217,0.18);
      --nav:          rgba(250,250,247,0.85);
      --card:         #FFFFFF;
      ...
      --phone-frame:  linear-gradient(145deg,#E6E4DE,#CECCCA);
      --phone-scr:    #EAE9E4;
      --phone-btn:    rgba(0,0,0,0.18);
      --phone-brd:    rgba(0,0,0,0.06);
    }
    ...
    [data-theme="dark"] {
      ...
      --gold-brd:     rgba(212,168,83,0.22);
      --gold-t:       #D4A853;
      --emerald:      #34D399;
      --em-dim:       rgba(52,211,153,0.12);
      --em-brd:       rgba(52,211,153,0.22);
      --amber:        #F59E0B;
      --am-dim:       rgba(245,158,11,0.12);
      --am-brd:       rgba(245,158,11,0.22);
      --blue:         #60A5FA;
      --bl-dim:       rgba(96,165,250,0.12);
      --bl-brd:       rgba(96,165,250,0.22);
      --purple:       #A78BFA;
      --pu-dim:       rgba(167,139,250,0.12);
      --pu-brd:       rgba(167,139,250,0.22);
      --nav:          rgba(7,8,15,0.85);
      --card:         #111320;
      --card-sh:      0 1px 0 rgba(255,255,255,0.04);
      --card-hover:   0 20px 60px rgba(0,0,0,0.5);
      --phone-frame:  linear-gradient(145deg,#1C1F2E,#0F1018);
      --phone-scr:    #08090E;
      --phone-btn:    rgba(255,255,255,0.09);
      --phone-brd:    rgba(255,255,255,0.04);
    }
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .rb-nav-inner {
      background: var(--nav); backdrop-filter: saturate(180%) blur(22px); -webkit-backdrop-filter: saturate(180%) blur(22px);
      border: 1px solid var(--bd); border-radius: 18px; height: 58px;
    ...
    @media(min-width:1024px){ .rb-hero { padding-top: 112px; padding-bottom: 88px; } }
    ...
    .rb-hero-grid { display: grid; grid-template-columns: 1fr; gap: 56px; align-items: center; position: relative; z-index: 2; }
    @media(min-width:1024px){ .rb-hero-grid { grid-template-columns: 1fr 1fr; gap: 64px; } }
    ...
    /* hero phone */
    .rb-hero-phone-col { display:none; justify-content:center; align-items:center; position:relative; }
    @media(min-width:1024px){ .rb-hero-phone-col { display:flex; } }
    .rb-phone-platform-glow { position:absolute; bottom:-40px; left:50%; transform:translateX(-50%); width:260px; height:70px; background:radial-gradient(ellipse,var(--gold-dim) 0%,transparent 70%); filter:blur(18px); pointer-events:none; opacity:0.8; }
    .rb-elite-phone { position:relative; width:275px; height:578px; border-radius:50px; background:var(--phone-frame); padding:10px; box-shadow:inset 0 0 0 1px rgba(255,255,255,0.14),inset 0 2px 6px rgba(255,255,255,0.07),0 40px 90px -20px rgba(0,0,0,0.2),0 0 50px -10px var(--gold-dim); transition:transform 0.6s cubic-bezier(0.16,1,0.3,1),box-shadow 0.6s; }
    [data-theme="dark"] .rb-elite-phone { box-shadow:inset 0 0 0 1px rgba(255,255,255,0.07),0 40px 100px -20px rgba(0,0,0,0.85),0 0 60px -10px var(--gold-dim); }
    .rb-elite-phone:hover { transform:translateY(-10px) scale(1.01); }
    .rb-phone-rim { position:absolute; inset:-1px; border-radius:51px; background:linear-gradient(135deg,rgba(255,255,255,0.16) 0%,transparent 30%,transparent 70%,rgba(255,255,255,0.07) 100%); pointer-events:none; z-index:20; }
    .rb-phone-vol-silent,.rb-phone-vol-up,.rb-phone-vol-down { position:absolute; left:-3px; width:3px; background:var(--phone-btn); border-radius:2px 0 0 2px; }
    .rb-phone-vol-silent { top:104px; height:23px; }
    .rb-phone-vol-up { top:146px; height:46px; }
    .rb-phone-vol-down { top:205px; height:46px; }
    .rb-phone-power { position:absolute; right:-3px; top:153px; width:3px; height:62px; background:var(--phone-btn); border-radius:0 2px 2px 0; }
    .rb-phone-inner { width:100%; height:100%; border-radius:42px; background:var(--phone-scr); overflow:hidden; position:relative; border:0.5px solid var(--phone-brd); }
    .rb-phone-island { position:absolute; top:14px; left:50%; transform:translateX(-50%); width:86px; height:26px; background:#000; border-radius:17px; z-index:30; box-shadow:inset 0 -1px 3px rgba(255,255,255,0.08); }
    .rb-phone-screen { position:absolute; inset:0; border-radius:42px; overflow:hidden; }
    .rb-phone-sheen { position:absolute; inset:0; z-index:10; pointer-events:none; border-radius:inherit; background:linear-gradient(135deg,rgba(255,255,255,0.1) 0%,transparent 40%); }
    .rb-phone-speaker { position:absolute; bottom:12px; left:50%; transform:translateX(-50%); width:42px; height:4px; background:var(--phone-btn); border-radius:2px; z-index:30; }

    /* chips */
    .rb-chip { position:absolute; display:flex; align-items:center; gap:10px; padding:10px 14px; border-radius:14px; background:var(--card); border:1px solid var(--bd-med); backdrop-filter:blur(20px); white-space:nowrap; box-shadow:var(--card-sh); }
    .rb-chip--top { top:10%; left:-22%; }
    .rb-chip--bottom { bottom:13%; right:-18%; }
    .rb-chip-ico { width:30px; height:30px; border-radius:8px; display:flex; align-items:center; justify-content:center; flex-shrink:0; }
    .rb-chip-ico--gold    { background:var(--gold-dim); color:var(--gold); }
    .rb-chip-ico--emerald { background:var(--em-dim);   color:var(--emerald); }
    .rb-chip-title { font-size:12px; font-weight:600; color:var(--t1); }
    .rb-chip-sub   { font-size:10.5px; color:var(--t2); }
    ...
    /* BENTO — 3-col grid, correct layout */
    .rb-bento { display:grid; grid-template-columns:1fr; gap:14px; }
    @media(min-width:768px){
      .rb-bento { grid-template-columns:repeat(3,1fr); }
      .rb-bcard--w2 { grid-column:span 2; }
      /* Row 1: [AI ×2][Qur'an ×1]  Row 2: [Name ×1][Streak ×1][Share ×1] */
    }
    ...
    .rb-glow--gold   { background:var(--gold-dim); opacity:0.7; }
    .rb-glow--emerald{ background:var(--em-dim); }
    .rb-glow--purple { background:var(--pu-dim); }
    .rb-glow--amber  { background:var(--am-dim); }
    .rb-glow--blue   { background:var(--bl-dim); }
    ...
    .rb-ico--gold    { background:var(--gold-dim); color:var(--gold);    border-color:var(--gold-brd); }
    .rb-ico--emerald { background:var(--em-dim);   color:var(--emerald); border-color:var(--em-brd);   }
    .rb-ico--purple  { background:var(--pu-dim);   color:var(--purple);  border-color:var(--pu-brd);   }
    .rb-ico--amber   { background:var(--am-dim);   color:var(--amber);   border-color:var(--am-brd);   }
    .rb-ico--blue    { background:var(--bl-dim);   color:var(--blue);    border-color:var(--bl-brd);   }
    ...
    .rb-pip--on    { background:linear-gradient(135deg,var(--gold-b),var(--gold)); }
    .rb-pip--today { background:var(--emerald); box-shadow:0 0 7px var(--em-dim); }
    .rb-pip--off   { background:var(--sf2); border:1px solid var(--bd); }
    ...
    .rb-ldot--emerald { background:var(--emerald); }
    .rb-ldot--amber   { background:var(--amber); }
    ...
    .rb-dist-row span:first-child { color:var(--t2); }
    .rb-dist-row span:last-child { color:var(--t1); font-weight:500; }
