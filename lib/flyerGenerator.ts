        ...
        ">
            ...
            ">
              ...
              <div style="
                width: 120px;
                height: 2px;
                background: linear-gradient(90deg, transparent, #8B6F47, #C9A961, transparent);
                margin-bottom: 8px;
              "/>
              ...
              ">
                ...
                <span style="
                  ...
                  margin: 0;
                  line-height: 1.3;
                  text-shadow: 0 1px 3px rgba(255,255,255,0.5), 0 2px 6px rgba(201,169,97,0.4);
                  flex-shrink: 0;
                  white-space: nowrap;
                ">Reflection by</span>
                ...
                <span id="user-signature" style="
                  ...
                  padding: 0 8px;
                  text-shadow: 0 1px 2px rgba(255,255,255,0.6), 0 2px 8px rgba(201,169,97,0.5);
                  position: relative;
                  z-index: 2;
                  white-space: nowrap;
                  max-width: 550px;
              ...
              <div style="
                width: 120px;
                height: 2px;
                background: linear-gradient(90deg, transparent, #C9A961, #8B6F47, transparent);
                margin-top: 8px;
              "/>
            </div>
        </div>
        ...
        <script>
          (function(){
            try {
              ...
              // Parent width constraint (accounting for stars, label, gaps)
              const maxWidth = 550;
              const containerMaxWidth = 1000;
              
              const fits = () => {
                return el.scrollWidth <= maxWidth && container.scrollWidth <= containerMaxWidth;
              };
              ...
              // Final check - if still too large, go smaller
              if (!fits() && fontSize > 14) {
